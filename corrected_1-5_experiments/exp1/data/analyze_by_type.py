...
def main():
    ...
    # Handle if running from either directory name
    if not results_file.exists():
        alt_path = Path("/l/users/muhra.almahri/Surgical_COT/corrected_1-5_experiments/results/exp1_evaluation_results.json")
        if alt_path.exists():
