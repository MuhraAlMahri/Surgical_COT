...
def evaluate(pred_path, cfg_path="corrected 1-5 experiments/exp1/config_exp1.yaml"):
...
if __name__ == "__main__":
    per_type, micro, counts, correct = evaluate("corrected 1-5 experiments/exp1/outputs/predictions.jsonl")
