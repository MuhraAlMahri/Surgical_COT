...
def main():
    cfg_path = "corrected 1-5 experiments/exp1/config_exp1.yaml"
    ...
    # Create tiny subset
    tiny_train = "corrected 1-5 experiments/exp1/outputs/tiny_train.jsonl"
    n_train = create_tiny_dataset(train_enriched, tiny_train, n_samples=64)
    
    tiny_val = "corrected 1-5 experiments/exp1/outputs/tiny_val.jsonl"
    ...
    args = TrainingArguments(
        output_dir="corrected 1-5 experiments/exp1/outputs/sanity_overfit",
